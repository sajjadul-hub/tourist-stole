...
const Services = () => {
    ...
    return (
       <div>
        ...
        <p className='text-gray-600 mx-4 '>Tour and travel guides, also known as tour directors or step-on tour guides, escort people on trips or give tours of locations of interest. <br/>People in this occupation: may travel with tourists to their destination. may work at a place of interest, such as a city, historical site or theme park. </p>
        </div>
